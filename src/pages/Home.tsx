    ...
    <div className="home-page">
        ...
        <div className="streaming-links">
            ...
            <a href="https://open.spotify.com/artist/4j0ndzELCmHK752wwibr7b" target="_blank" rel="noreferrer">
                <img src="assets/link_images/jmspotify.png" alt="Spotify" className="streaming-icon" />
            </a>
            <a href="https://music.apple.com/gb/artist/junk-mail/1675917204" target="_blank" rel="noreferrer">
                <img src="assets/link_images/jmapple.png" alt="Apple Music" className="streaming-icon" />
            </a>
        </div>
        ...
        <div className="band-image">
            <img src="assets/bandimages/jmband.jpg" alt="Band" />
        </div>
    </div>
);
